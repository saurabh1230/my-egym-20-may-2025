...
class EditMemberScreen extends StatelessWidget {
  ...
  EditMemberScreen({super.key, this.memberList});
  ...
  Widget build(BuildContext context) {
    ...
    memberNameController.text = memberList?["full_name"] ?? '';
    dobController.text = DateConverter.formatDateDMYString(
      inputDate: memberList?['date_of_birth']?.toString() ?? '',
      inputFormat: 'yyyy-MM-dd',
      outputFormat: 'dd/MM/yyyy', // ← use slashes here
    );
    phoneController.text = memberList?["phone_number"] ?? '';
    emailController.text = memberList?["email"] ?? '';
    zipCodeController.text = memberList?["zip_code"] ?? 'N/A';
    addressController.text = memberList?["address"] ?? 'N/A';
    emergencyNameController.text = memberList?["emergency_contact_name"] ?? 'N/A';
    emergencyPhoneController.text = memberList?["emergency_contact_phone"] ?? 'N/A';
                                    ...
                                    onPressed: () {
                                      if (formKey.currentState!.validate()) {
                                        memberControl.updateMember(
                                          ...
                                          password:
                                          confirmPasswordController.text, memberID: memberList!["id"].toString(),
                                        );
                                      } else {
