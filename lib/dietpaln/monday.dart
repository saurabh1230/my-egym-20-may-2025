...
//     final key = "${widget.monthId}_${widget.weekId}_Monday";
...
//       final availableMealTypes = controller.mealTypes
//           .where((type) => !usedMealTypes.contains(type))
//           .toList();
//
//       return _buildDropdown(
...
//     setState(() {});
//
//     // Check if 5 meals are added, then go to next
